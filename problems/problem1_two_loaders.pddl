(define (problem airo2_group_K_problem_1)   
	...
	(:objects 
        ...
        loader1 loader2 - obj ; load the crates
        crate1 crate2 crate3 crate4 crate5 - obj ; crates to move
	...
	(= (weight_crate crate1) 70) 
        ...
        (= (timer mover1) 0) 
        (= (timer mover2) 0)
        (= (timer_mover_waiting_for_free_loading_bay mover1) 0)
         (= (timer_mover_waiting_for_free_loading_bay mover2) 0)
